  ...
  return (
    <>
         ...
         <MenuPortal id="footer_menu" activeMenu={activeMenu} menuPos={menuPos} closeMenu={closeMenu}>
              <div className="p-1">
                  <button className="w-full text-left px-3 py-2 hover:bg-slate-100 text-xs font-medium text-slate-700 rounded-md" onClick={() => { executeCommand('insertHTML', '<footer style="border-top:1px solid #ccc; padding-top:5px; margin-top:15px; color:#666; font-size:0.8em;">Footer</footer>'); closeMenu(); }}>Default Footer</button>
